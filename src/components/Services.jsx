...
function Services() {
  return (
      <section className="flex flex-col  md:flex-row p-3 items-center md:justify-center space-x-6 mt-28">
          ...
          <div className="h-min group after:absolute after:scale-x-0 after:transition-transform  after:origin-center hover:after:scale-x-100 after:top-0 after:left-0 after:w-full after:h-full after:border-b-2 after:border-black relative p-6 pb-10 pt-16 rounded-md box-shadow max-w-[23rem]">
                <figure className="flex items-center justify-center w-max mb-10 mx-auto">
